...
use log4tc_core::MessageFormatter;
use std::collections::HashMap;

#[test]
fn test_format_realistic_log_messages() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!("motor_001"));
    args.insert(1, serde_json::json!(5000));
    args.insert(2, serde_json::json!("rpm"));
...
fn test_format_with_context_realistic() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!("alice"));
...
fn test_format_multiple_same_placeholder() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!("ERROR"));
...
fn test_format_mixed_placeholders() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!("123"));
    args.insert(1, serde_json::json!("456"));
...
fn test_format_with_numeric_values() {
    ...
    args.insert(1, serde_json::json!(3.14159));
...
fn test_format_with_special_characters_in_values() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!(r#"Path: "C:\Program Files\""#));
    args.insert(1, serde_json::json!("<tag>value</tag>"));
    args.insert(2, serde_json::json!("Line 1\nLine 2\nLine 3"));
...
fn test_format_with_unicode_in_template_and_args() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!("世界"));
...
fn test_format_array_and_object_values() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!([1, 2, 3, 4, 5]));
    args.insert(1, serde_json::json!({"key": "value", "nested": {"inner": true}}));
...
fn test_format_empty_values() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!(""));
    args.insert(1, serde_json::json!(null));
...
fn test_format_very_long_argument_values() {
    ...
    args.insert(0, serde_json::json!(&long_value));
...
fn test_format_plc_error_message_scenario() {
    let mut args = HashMap::new();
    args.insert(0, serde_json::json!("MotorControl"));
    args.insert(1, serde_json::json!("TIMEOUT"));
