...
namespace Log4Tc.Output.InfluxDb.Test
{
    public class SysLogPointFactoryTest
    {
        ...
        public void CreatePoint_ShouldLogLogEntry()
        {
            ...
            var logEntry = new LogEntry
            {
                ...
                OnlineChangeCount = 2,
                PlcTimestamp = new DateTime(2020, 7, 13, 15, 53, 21, 345, DateTimeKind.Utc),
            };
