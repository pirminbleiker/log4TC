...
# Install
New-Service -Name $serviceName -BinaryPathName "$servicePath\$serviceName.exe --service" -Description "Log4Tc service" -DisplayName $serviceName -StartupType Automatic -DependsOn "TcSysSrv"
