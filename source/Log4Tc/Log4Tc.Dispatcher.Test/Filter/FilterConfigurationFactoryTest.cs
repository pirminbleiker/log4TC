...
using Log4Tc.Dispatcher.Filter;
using Microsoft.Extensions.Configuration;
using Optional;
using System.Linq;
using Xunit;

namespace Log4TcDispatcher.Test.Filter
{
    public class FilterConfigurationFactoryTest
    {
        ...
        {
            // Arrange
            var configuration = new ConfigurationBuilder().AddJsonStream(GetType().Assembly.GetManifestResourceStream("Log4TcDispatcher.Test.Filter.assets.EmptyFilter.json")).Build();
        ...
        {
            // Arrange
            var configuration = new ConfigurationBuilder().AddJsonStream(GetType().Assembly.GetManifestResourceStream("Log4TcDispatcher.Test.Filter.assets.StringFilter.json")).Build();
        ...
        {
            // Arrange
            var configuration = new ConfigurationBuilder().AddJsonStream(GetType().Assembly.GetManifestResourceStream("Log4TcDispatcher.Test.Filter.assets.SingleSimpleFilter.json")).Build();
        ...
        {
            // Arrange
            var configuration = new ConfigurationBuilder().AddJsonStream(GetType().Assembly.GetManifestResourceStream("Log4TcDispatcher.Test.Filter.assets.MultipleSimpleFilter.json")).Build();
