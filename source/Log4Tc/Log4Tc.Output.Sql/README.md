...
```json
      "Config": {
        "Driver": "MySql",
        "ConnectionString": "Server=log4tc-srv02;Port=13306;Database=log4tc_fullflat;Uid=root;Pwd=root;",
        "Scheme": "FullFlat"
      }
```
...
```json
      "Config": {
        "Driver": "Postgres",
        "ConnectionString": "User ID=postgres;Password=postgres;Host=log4tc-srv02;Port=15432;Database=log4tc_fullflat;Pooling=true;",
        "Scheme": "FullFlat"
      }
```
...
```json
      "Config": {
        "Driver": "SqlServer",
        "ConnectionString": "Server=log4tc-srv02,11433;Database=log4tc_fullflat;User Id=sa;Password=sa!12345678;",
        "Scheme": "FullFlat"
      }
```
